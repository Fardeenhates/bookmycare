                    ...
                    >
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-sky-600 font-medium">{doc.specialization}</p>
                        </div>
        ...
        {currentPage === 'login' && (
          <section className="pt-40 pb-20 px-6 flex justify-center">
            ...
            >
              ...
              {authMode === 'login' && (
                <div className="mb-6 p-4 bg-sky-50 rounded-2xl border border-sky-100 text-xs text-sky-800">
                  <p className="font-bold mb-2 uppercase tracking-wider">Demo Accounts:</p>
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <p className="font-semibold">Admin:</p>
                      <p>admin@bookmycare.com</p>
                      <p>admin123</p>
                    </div>
                    <div>
                      ...
                      <div className="glass p-8 rounded-3xl text-center">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div className="bg-slate-50 p-3 rounded-xl">
                            <span className="block text-slate-400 mb-1">Blood Group</span>
                            <span className="font-bold">O+</span>
                          </div>
                          <div className="bg-slate-50 p-3 rounded-xl">
                            <span className="block text-slate-400 mb-1">Age</span>
                      ...
                      <div className="lg:col-span-2 space-y-8">
                        <div className="glass p-8 rounded-3xl">
                          <h3 className="text-xl font-bold mb-6 flex justify-between items-center">
                            Manage Doctors
                            <button className="text-sm bg-sky-600 text-white px-4 py-2 rounded-xl hover:bg-sky-700 transition-all">
                              Add New Doctor
                            </button>
                          </h3>
                              ...
                              <tbody className="text-sm">
                                {doctors.map(doc => (
                                  <tr key={doc.id} className="border-b border-slate-50">
                                    <td className="py-4 font-bold">Dr. {doc.name}</td>
                                    <td className="py-4 text-slate-500">{doc.specialization}</td>
